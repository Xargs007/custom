...
function c911000362.initial_effect(c)
	--send to grave
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(911000362,0))
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c911000362.target)
	e1:SetOperation(c911000362.operation)
	c:RegisterEffect(e1)
end
function c911000362.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c911000362.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
